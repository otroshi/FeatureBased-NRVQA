...
**Note:** To run these codes, you need to download the following mat files:
- [`CSIQ_codebook_BS7.mat`](https://github.com/otroshi/FeatureBased-NRVQA/releases/download/v1.0/CSIQ_codebook_BS7.mat)
- [`LIVE_soft_svm_model.mat`](https://github.com/otroshi/FeatureBased-NRVQA/releases/download/v1.0/LIVE_soft_svm_model.mat)
